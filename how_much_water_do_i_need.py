...
# You are given a clothes amount of clothes to wash. For each single item of clothes above the load, 
...
# Write a function howMuchWater (JS)/how_much_water (Python and Ruby) to work out 
# how much water is needed if you have a clothes amount of clothes. The function will accept 3 arguments: - water, load (or max_loadin Ruby) 
# and clothes.
...
def how_much_water(water, load, clothes):
    if clothes > 2*load:
        ...
        water = float(water) * 1.1**float(clothes-load)
